    ...
    <div className="flex flex-row justify-center items-center py-16">
      <div className="flex-1 flex flex-col">
        ...
        <p className="text-lg px-20 py-4">
          Unlock early access to our powerful new tool. Enter your email to get
          started
        </p>
      </div>
      <div className="flex-1 flex flex-col">
        <form className="max-w-full mx-8 p-4">
          ...
          <div className="mb-5">
            ...
            <select
              id="jobFunction"
              className="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none"
            >
              <option selected>Select...</option>
              <option value="Sales, Business">Sales, Business</option>
              <option value="Operations">Operations</option>
              <option value="Legal">Legal</option>
              <option value="Finance, Producrement">
                Finance, Procurement
              </option>
