...
export const toggleBlock = (editor: any, format: string) => { // Specify types
...
export const isBlockActive = (editor: any, format: string, blockType: string = 'type') => { // Specify types
...
export const BlockButton: React.FC<{ format: string; icon: React.ReactNode; title: string }> = ({ format, icon, title }) => { // Specify props types
