    ...
    return (
        <footer className='bottom-0 left-0 right-0 w-full bg-secondary'>
            <div className='p-6'>
                ...
                <span className='block text-sm text-gray-500 sm:text-center dark:text-gray-400'>© 2024 <a href='https://apprvd.co/' className='hover:underline'>Apprvd</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
};
