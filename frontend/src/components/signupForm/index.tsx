        ...
        <div className='flex flex-col px-36 py-16 max-w-full w-full'>
            ...
            <form className='max-w-full w-full'>
                <div className='mb-5'>
                    ...
                    <input type='name' id='name' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none' placeholder='apprvd co' required />
                </div>
                <div className='mb-5'>
                ...
                <button type='submit' className='text-white bg-tertiary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm w-full px-5 py-2.5 text-center outline-none'>Sign up</button>
            </form>
            <div className='flex flex-row mt-4'>
                <p>Have an account?</p>
                <a href='/login' className='ml-2 text-primary font-semibold hover:scale-110 transition-all duration-300'>Login</a>
            </div>
        </div>
    )
};
