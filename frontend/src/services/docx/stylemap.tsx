...
class StyleMap {
    ...
    constructor(styles: any, numberingMap: any) {
        this.styles = styles;
    ...
    hasStyle(styleName: any){
        return this.nameToFormat.has(styleName);
    }
    styleAdded(styleName: any){
        return this.nameToFormat.set(styleName, true);
    }
    cloneStyle(styleName: any, curStyleMap: any) {
...
function getStyleMap(docx: any, numberingMap: any){
